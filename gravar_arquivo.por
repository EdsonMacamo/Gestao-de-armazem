...
programa
{
	...
	funcao inicio()
	{
		...
		cadeia nome,apelido,provincia
		
		escreva("Digite o seu nome","\n")
		leia(nome)
		escreva("Digite o seu apelido")
		leia(apelido)
		escreva("Digite a sua provincia")
		leia(provincia)
		a.escrever_linha(nome, endereco)
		a.escrever_linha(apelido, endereco)
		a.escrever_linha(provincia, endereco)
